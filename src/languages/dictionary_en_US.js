if (!FrameworkI18N) {
  var FrameworkI18N = {
    message:
    {
      ...
      "label.any":                      "Any",
      "specify.contact":                "- Please specify a contact\r\n",
      "webcal.message":                 "Viewing your CRM calendar offline requires an iCalendar compliant desktop application. These applications include Mozilla Sunbird, Apple iCal, and possibly others.   \r\n\r\nThis feature may not work on your system.",
